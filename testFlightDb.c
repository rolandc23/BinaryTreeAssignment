...
static void testDbInsertRecord(void) {
    ...
    Record recs[] = {
        ...
        // this should be inserted
        RecordNew("VA322", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA321", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA320", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA324", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA325", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA326", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA327", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA328", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA329", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA330", "MEL", "BNE", 6, 11,  0, 110),

        // this should be inserted
        RecordNew("VA331", "MEL", "BNE", 6, 11,  0, 110),
    };

    doTestDbInsertRecord(recs, 17);
}
...
static void testDbFindByFlightNumber(void) {
    ...
    doTestDbFindByFlightNumber(db, "QF531");
    doTestDbFindByFlightNumber(db, "AA999");
    doTestDbFindByFlightNumber(db, "ZZ999");
...
static void testDbFindByDepartureAirportDay(void) {
    ...
    doTestDbFindByDepartureAirportDay(db, "ADL", 0);
    doTestDbFindByDepartureAirportDay(db, "ADL", 1);
    doTestDbFindByDepartureAirportDay(db, "ADL", 2);

    doTestDbFindByDepartureAirportDay(db, "MEL", 3);
    doTestDbFindByDepartureAirportDay(db, "MEL", 4);
    doTestDbFindByDepartureAirportDay(db, "MEL", 5);

    doTestDbFindByDepartureAirportDay(db, "BNE", 0);
    doTestDbFindByDepartureAirportDay(db, "BNE", 1);
    doTestDbFindByDepartureAirportDay(db, "BNE", 2);
...
static void testDbFindBetweenTimes(void) {
    ...
    // Monday 12am-12am
    doTestDbFindBetweenTimes(db, 0,  0, 0, 0,  0,  0);

    // Monday 7am-8am
    doTestDbFindBetweenTimes(db, 0,  7, 0, 0,  8,  0);

    // Monday 1305-1305
    doTestDbFindBetweenTimes(db, 0,  13, 5, 0,  13,  5);
...
static void testDbFindNextFlight(void) {
    ...
    doTestDbFindNextFlight(db, "AA999", 0, 0, 0);

    doTestDbFindNextFlight(db, "ZZ999", 6, 22, 0);

    doTestDbFindNextFlight(db, "QF529", 6, 22, 0);

    doTestDbFindNextFlight(db, "QF531", 6, 22, 0);
